...
VALUES ('Buy cheese', 'Go to the shop and buy some Cheddar', 'TODO', '2026-05-01 12:00:00'),
       ...
       ('Read a book', 'Finish "Clean Code" by Robert Martin', 'TODO', NULL)
ON CONFLICT (tasks) DO NOTHING;
...
VALUES (1, 1),
       ...
       (2, 3),
       (3, 4)
ON CONFLICT (users_tasks) DO NOTHING;
...
VALUES (1, 'ROLE_ADMIN'),
       ...
       (2, 'ROLE_USER'),
       (3, 'ROLE_USER')
ON CONFLICT (users_roles) DO NOTHING;